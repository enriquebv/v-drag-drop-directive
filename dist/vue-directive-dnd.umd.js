(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-directive-dnd"] = factory();
	else
		root["vue-directive-dnd"] = factory();
...
const getCommonDirectiveConfig = (directive, binding, options) => {
...
const simulateDragEvent = (type, element) => {
...
const copyBorderRadius = (source, target) => {
...
// CONCATENATED MODULE: ./src/touch.js



class touch_TouchDragEvent {
  constructor(options) {
  ...
  createGhost(event, target) {
    ...
    html2canvas_default()(target).then(canvas => {
...
/* harmony default export */ var draggable = ({
  bind(element, binding, vnode) {
    ...
    const touchDragEvent = new touch_TouchDragEvent({
      element
    });
...
const droppable_processDirectiveOptions = (element, options) => {
...
/* harmony default export */ var droppable = ({
  bind(element, binding) {
    droppable_processDirectiveOptions(element, binding.value);
  },
  update(element, binding) {
    droppable_processDirectiveOptions(element, binding.value);
  },
...
//# sourceMappingURL=vue-directive-dnd.umd.js.map